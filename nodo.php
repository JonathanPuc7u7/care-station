<?php
  ...
  $temperatura="SELECT * FROM temperatura WHERE nodo = $idnodo order by idtemp desc limit 10;";
  $humedad="SELECT * FROM humedad WHERE nodo = $idnodo order by idhum desc limit 10;";
  $humedad_suelo="SELECT * FROM humedad_suelo WHERE nodo = $idnodo order by idhum_su desc limit 10;";
  $uv="SELECT * FROM uv WHERE nodo = $idnodo order by iduv desc limit 10;";
?>
<!DOCTYPE html>
<html lang="en">
<head>
